...
feature_signif <- load_doomics("signif", params$cache_dir) %>%
  filter(
...
# all models fit
all_model_signif <- load_doomics("all_model_signif", params$cache_dir) %>%
...
gene_set_path <- load_doomics("gene_sets", params$cache_dir)
gmts_used <- c(
